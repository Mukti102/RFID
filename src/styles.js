const style = {
    // Buttons
    btnBlue: "font-bold w-fit text-base sl:text-[18px] px-3 sl:px-8 py-3 sl:py-[18px] rounded-md bg-primary hover:drop-shadow-[0_4px_20px_rgba(240,201,26,.5)] hover:-translate-y-1 transition duration-150 ease-in",
    ...
    headingS: " text-secondary font-bold",
